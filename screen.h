...
// max possible screen size for memory allocation
const int   MAXX = 1000;
const int   MAXY = 1000;
...
s_simplechar WRITECHAR = { " ", 7, 0, false, false, false};
...
class Cscreen {
    ...
    public:
        ...
        int getScreenWidth() { return SCREENX; }

        int getScreenHeight() { return SCREENY; }
